...
import 'package:flutterapptaxi/src/fire_base/fire_base_auth.dart';
...
//  StreamController _emailLoginController = new StreamController();
//  StreamController _passLoginController = new StreamController();

  Stream get nameStream => _nameController.stream;
  Stream get emailStream => _emailController.stream;
  Stream get passStream => _passController.stream;
  Stream get phoneStream => _phoneController.stream;
//  Stream get emailLoginStream => _emailLoginController.stream;
//  Stream get passLoginStream => _passLoginController.stream;
